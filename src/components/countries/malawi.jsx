...
// Images
import malawiImg from "../../assets/Malawi.jpg";
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Malawi Relief Fund</h2>
...
function Malawi() {
  const infoCards = [
    "Malawi struggles with poverty, food insecurity, and limited access to healthcare, especially in rural regions.",
    "Your donations help deliver food, medical care, clean water, and shelter to vulnerable families and children in Malawi.",
    "Our projects focus on sustainable solutions—supporting orphans, drilling wells, and running mobile clinics across the country.",
    "Together, we can restore dignity and hope to communities hit by droughts, poverty, and displacement in Malawi.",
  ];

  const projects = [
    { title: "Emergency Food Aid Malawi", desc: "Distribute food parcels to drought-affected families in Malawi.", img: foodImg },
    { title: "Mobile Medical Units", desc: "Provide basic healthcare to remote and underserved villages.", img: medicalImg },
    { title: "Sponsor a Malawian Orphan", desc: "Support orphaned children with food, shelter, and education.", img: orphansImg },
    { title: "Clean Water for Malawi", desc: "Drill wells and install safe water points in rural areas.", img: malawiImg },
    { title: "Ramadan Relief Malawi", desc: "Provide Iftar food packs to needy families during Ramadan.", img: foodImg },
  ];
  ...
  return (
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${malawiImg})` }}
      >
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Bring Relief to Malawi's Most Vulnerable</h2>
