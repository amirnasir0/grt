...
import drinkWaterImg from "../../assets/Drink_water.png";
import medicalImg from "../../assets/Medical.png";
import educationImg from "../../assets/Education.jpg";
import buildHomesImg from "../../assets/Build_Homes.png";
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Pakistan Relief Fund</h2>
...
function Pakistan() {
  ...
  const projects = [
    { title: "Flood Relief Food Pack", desc: "Support families with monthly food essentials.", img: foodImg },
    { title: "Clean Water Hand Pumps", desc: "Provide villages with safe water access.", img: drinkWaterImg },
    { title: "Medical Camps & Aid", desc: "Distribute medicines and offer health services.", img: medicalImg },
    { title: "Education for Children", desc: "Sponsor school kits and training for kids.", img: educationImg },
    { title: "Emergency Relief Kits", desc: "Deliver essential supplies during floods.", img: buildHomesImg },
  ];
  ...
  return (
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${pakistanImg})` }}
      >
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Support Vulnerable Communities in Pakistan</h2>
