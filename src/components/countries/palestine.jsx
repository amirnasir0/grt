...
// Images
import gazaImg from "../../assets/Gaza.png";
import foodImg from "../../assets/Food.jpg";
import waterImg from "../../assets/Drink_water.png";
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Gaza Relief Fund</h2>
...
function Palestine() {
  ...
  const projects = [
    { title: "Gaza Food Pack", desc: "Provide essential food items to displaced families.", img: foodImg },
    { title: "Clean Water for Gaza", desc: "Supply safe drinking water to homes and hospitals.", img: waterImg },
    { title: "Emergency Medical Aid", desc: "Support hospitals with lifesaving medical supplies.", img: medicalImg },
    { title: "Sponsor a Gaza Orphan", desc: "Ensure shelter, education, and care for orphans.", img: orphanImg },
  ];
    ...
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Support Gaza's Most Vulnerable</h2>
