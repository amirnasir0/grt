...
import malnutritionImg from "../../assets/Yemen_Malnutrition.png";
import foodImg from "../../assets/Food.jpg";
import medicalImg from "../../assets/Medical.png";
import shelterImg from "../../assets/Build_Homes.png";
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Yemen Relief Fund</h2>
...
function Yemen() {
  const infoCards = [
    "Yemen faces one of the world's worst humanitarian crises due to ongoing conflict and economic collapse.",
    "Millions are on the brink of famine with children suffering from severe malnutrition.",
    "Hospitals are overcrowded and lack essential medicines, equipment, and staff.",
    "Your donations can deliver food, clean water, shelter, and medical support to the most vulnerable.",
  ];

  const projects = [
    { title: "Yemen Food Pack", desc: "Distribute life-saving food packs to starving families.", img: foodImg },
    { title: "Clean Water for Yemen", desc: "Provide safe drinking water through tankers and wells.", img: yemenImg },
    { title: "Emergency Healthcare", desc: "Deliver medical aid to overstretched hospitals.", img: medicalImg },
    { title: "Orphan Sponsorship", desc: "Support education and shelter for orphans.", img: malnutritionImg },
    { title: "Shelter & Hygiene Kits", desc: "Provide tents, clothing, and hygiene items to displaced families.", img: shelterImg },
  ];
    ...
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Support Yemen's Most Vulnerable</h2>
        ...
        <div className="bg-[#036ea8] text-white px-4 md:px-6 py-8 md:py-14 text-center">
          ...
          <p className="text-sm md:text-md">[Daraqutni]</p>
        </div>
