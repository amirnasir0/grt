...
// Images
import hifzImage from "../../assets/Hifz_Sponsorship.png";
import orphanSponsorshipImg from "../../assets/orphan.png";
import mostUrgentFundImg from "../../assets/Most_Urgent_Fund.jpg";
import foodPackImg from "../../assets/Food.jpg";
import buildSchoolImg from "../../assets/education_thumbnail.png";
import mediKitImg from "../../assets/Medical.png";
...
const predefinedAmounts = [
  ...
  { value: 1700, label: "Family Relief Pack" },
];
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Hifz Sponsorship Fund</h2>
...
function HifzSponsorship() {
  ...
  const projects = [
    {
      title: "Sponsor 1 Hifz Student",
      desc: "Support a child memorising the Qur'an.",
      img: hifzImage,
    },
    {
      title: "Sponsor 5 Hifz Students",
      desc: "Multiply your reward by five.",
      img: orphanSponsorshipImg,
    },
    {
      title: "Qur'an & Study Material Kit",
      desc: "Provide essential learning resources.",
      img: mediKitImg,
    },
    {
      title: "Sponsor Monthly Food Pack",
      desc: "Ensure nutritious meals for Hifz students.",
      img: foodPackImg,
    },
    {
      title: "Build a Hifz School Classroom",
      desc: "Create safe, dedicated learning spaces.",
      img: buildSchoolImg,
    },
  ];
  ...
  return (
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${hifzImage})` }}
      >
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-0 items-start justify-center px-4 lg:px-10">
          ...
          <div className="w-full lg:w-[700px]">
            <img
              src={hifzImage}
              alt="Hifz Quran Memorization Program"
        ...
        <section className="px-4 py-8 md:py-10 flex justify-center">
          <iframe
            ...
            src="https://www.youtube.com/embed/VzJ01DNPRZA?autoplay=1&enablejsapi=1"
            title="GRT Hifz Sponsorship Appeal"
            frameBorder="0"
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Preserve the Qur'an, One Heart at a Time</h2>
