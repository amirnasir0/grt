...
// Images
import orphanImage from "../../assets/ORPHANS.png";
import educationImage from "../../assets/education_thumbnail.png";
import foodImage from "../../assets/Food.jpg";
import medicalImage from "../../assets/Medical.png";
import clothingImage from "../../assets/women.png";
import eidGiftImage from "../../assets/children.jpg";
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Orphan Sponsorship Fund</h2>
...
function OrphanSponsorship() {
  const infoCards = [
    "Millions of orphaned children lack access to basic education, nutrition, and healthcare.",
    "Your sponsorship provides school fees, meals, clothing, and vital healthcare for vulnerable orphans.",
    "Help us nurture orphans with emotional support and mentorship programs to build their future.",
    "Your compassion ensures orphans grow up safe, educated, and hopeful for a better tomorrow.",
  ];

  const projects = [
    { title: "Sponsor an Orphan", desc: "Support a child's full monthly care.", img: orphanImage },
    { title: "Education Support", desc: "Provide school essentials for orphans.", img: educationImage },
    { title: "Orphan Meals Program", desc: "Fund nutritious daily meals.", img: foodImage },
    { title: "Healthcare Aid", desc: "Cover orphans' medical expenses.", img: medicalImage },
    { title: "Orphan Clothing Drive", desc: "Distribute warm clothing and shoes.", img: clothingImage },
    { title: "Eid Gifts for Orphans", desc: "Bring smiles with toys and treats.", img: eidGiftImage },
  ];
  ...
  return (
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${orphanImage})` }}
      >
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <section className="px-4 py-8 md:py-10 flex justify-center">
          <iframe
            ...
            src="https://www.youtube.com/embed/imVyHKL576U?autoplay=1&enablejsapi=1"
            title="GRT Orphan Sponsorship Appeal"
            frameBorder="0"
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Support Orphan Children Today</h2>
