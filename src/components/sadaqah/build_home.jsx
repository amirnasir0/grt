...
// Images
import buildHomeImg from "../../assets/Syria_Housing.png";
import widowImg from "../../assets/Women_Care_Pack.jpg";
import disasterImg from "../../assets/home.png";
import orphanImg from "../../assets/ORPHANS.png";
import communityImg from "../../assets/Malawi.jpg";
import shelterImg from "../../assets/Uganda.jpg";
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Build Home Fund</h2>
...
function BuildHome() {
  ...
  const projects = [
    { title: "Build a Family Home", desc: "Construct a safe shelter for a family.", img: buildHomeImg },
    { title: "Widow Housing Project", desc: "Secure housing for widowed women and children.", img: widowImg },
    { title: "Disaster Relief Housing", desc: "Rebuild homes destroyed by floods or earthquakes.", img: disasterImg },
    { title: "Orphan Family Homes", desc: "Shelter orphans with caring guardians.", img: orphanImg },
    { title: "Community Housing Block", desc: "Create clusters of homes for entire villages.", img: communityImg },
    { title: "Shelter for Displaced Families", desc: "Support refugee families with permanent homes.", img: shelterImg },
  ];
  ...
  return (
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${buildHomeImg})` }}
      >
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <section className="px-4 py-8 md:py-10 flex justify-center">
          <iframe
            ...
            src="https://www.youtube.com/embed/GtX7iF3fVOg?autoplay=1&enablejsapi=1"
            title="GRT Build Homes Appeal"
            frameBorder="0"
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Restore Shelter, Dignity & Hope</h2>
