...
import drinkWaterImage from "../../assets/Drink_water.png";
import barakahImage from "../../assets/Spread_Barakah.jpg";
import filterImage from "../../assets/Malnutrition2.png";
import rainHarvestImage from "../../assets/Uganda.jpg";
import emergencyImage from "../../assets/Yemen.png";
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">Water Project Fund</h2>
  ...
  const projects = [
    {
      ...
      desc: "Provide clean drinking water to families.",
      img: waterImage,
    },
    {
      title: "Community Water Tanks",
      desc: "Install tanks for clean, stored water.",
      img: drinkWaterImage,
    },
    {
      title: "Hand Pump Wells",
      desc: "Affordable water access for villages.",
      img: barakahImage,
    },
    {
      title: "Water Filter Distribution",
      desc: "Distribute filters to purify household water.",
      img: filterImage,
    },
    {
      title: "Rainwater Harvesting Systems",
      desc: "Capture and purify rainwater for daily use.",
      img: rainHarvestImage,
    },
    {
      title: "Emergency Water Relief",
      desc: "Deliver water to drought-affected regions.",
      img: emergencyImage,
    },
  ];
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <section className="px-4 py-8 md:py-10 flex justify-center">
          <iframe
            ...
            src="https://www.youtube.com/embed/UP0yf5PNgaY?autoplay=1&enablejsapi=1"
            title="GRT Water Project Appeal"
            frameBorder="0"
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Provide Clean Water</h2>
        ...
        <div className="bg-[#036ea8] text-white px-4 md:px-6 py-8 md:py-14 text-center">
          ...
          <blockquote className="text-3xl font-bold my-3 md:my-4 leading-relaxed">
            "The best charity is giving water to drink."
          </blockquote>
          <p className="text-sm md:text-md">[Ahmad]</p>
        </div>
