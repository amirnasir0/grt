...
import SideImage from "../../assets/education_thumbnail.png";
import img1 from "../../assets/student.png";
import img2 from "../../assets/children.jpg";
import img3 from "../../assets/Hifz_Sponsorship.png";
import img4 from "../../assets/ORPHANS.png";
import img5 from "../../assets/education_thumbnail.png";
import img6 from "../../assets/hifz.jpg";
...
const predefinedAmounts = [
  ...
  { value: 1600, label: "Family Relief Pack" },
];
...
function Education() {
  const infoCards = [
    "Millions of children around the world are denied access to basic education due to poverty.",
    "Your support helps build schools, provide uniforms, books, and cover teachers' salaries.",
    "Education transforms lives – it breaks the cycle of poverty and empowers communities.",
    "Let's ensure that every child has the opportunity to learn and grow with dignity.",
  ];

  const projects = [
    {
      title: "Sponsor a Child's Education",
      desc: "Help a child go to school with uniform, books, and tuition.",
      img: img1,
    },
    {
      title: "Build a Classroom",
      desc: "Support construction of safe learning environments for kids.",
      img: img2,
    },
    {
      title: "Provide School Kits",
      desc: "Distribute bags, stationery, and learning materials to students.",
      img: img3,
    },
    {
      title: "Train Teachers",
      desc: "Support training programs to enhance teaching skills in rural areas.",
      img: img4,
    },
    {
      title: "Qur'anic Education",
      desc: "Enable Islamic learning through structured Hifz & Qur'an classes.",
      img: img5,
    },
    {
      title: "Orphan School Support",
      desc: "Provide complete education for orphans in underserved communities.",
      img: img6,
    },
  ];
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <section className="px-4 py-8 md:py-10 flex justify-center">
          <iframe
            ...
            src="https://www.youtube.com/embed/lgt_ivV8gIQ?autoplay=1&enablejsapi=1"
            title="GRT Education Appeal"
            frameBorder="0"
        ...
        <div className="px-4 md:px-6 py-8 md:py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Education Empowers Generations</h2>
