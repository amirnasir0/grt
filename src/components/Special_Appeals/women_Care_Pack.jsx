...
// ✅ Main background and intro image
import womenCarePackImg from "../../assets/Women_Care_Pack.jpg";

// ✅ Project-specific images from your list
import ProjectImg1 from "../../assets/Women_Care_Pack.jpg";
import ProjectImg2 from "../../assets/Medical.png";
import ProjectImg3 from "../../assets/education_thumbnail.png";
import ProjectImg4 from "../../assets/Rohingya.jpg";
import ProjectImg5 from "../../assets/Malnutrition2.png";
import ProjectImg6 from "../../assets/women.png";
...
const predefinedAmounts = [
  ...
  { value: 650, label: "Education Kit" },
  { value: 900, label: "Family Relief Pack" },
];
...
function DonationCardInternal() {
  ...
  return (
    <div className="bg-white border border-[#A0A0A0] p-4 md:p-6 rounded shadow-lg text-[#1E1E1E] w-full">
      <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-center">            WOMEN'S CARE PACK
      </h2>
...
function WomenCarePack() {
  ...
  const projects = [
    {
      title: "Hygiene Care Pack",
      desc: "Provide hygiene essentials to vulnerable women.",
      img: ProjectImg1,
    },
    {
      title: "Safe Motherhood Kit",
      desc: "Support expectant mothers with essential supplies.",
      img: ProjectImg2,
    },
    {
      title: "School Girl Hygiene Kit",
      desc: "Distribute sanitary products to schoolgirls.",
      img: ProjectImg3,
    },
    {
      title: "Crisis Response Packs",
      desc: "Care kits for women in war or disaster zones.",
      img: ProjectImg4,
    },
    {
      title: "Malnutrition Relief Kit",
      desc: "Combine hygiene items with nutrition support.",
      img: ProjectImg5,
    },
    {
      title: "Women's Empowerment Pack",
      desc: "Confidence and care for vulnerable sisters.",
      img: ProjectImg6,
    },
  ];
  ...
  return (
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${womenCarePackImg})` }}
      >
      ...
      <div className="relative z-10 bg-gradient-to-b from-transparent to-[#FAFAFA]">
        ...
        <section className="px-4 py-8 md:py-10 flex justify-center">
          <iframe
            ...
            src="https://www.youtube.com/embed/QhQFt0vaWEU?autoplay=1&mute=1&enablejsapi=1"
            title="GRT Video 5"
            frameBorder="0"
        ...
        <div className="px-6 py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-3xl font-bold mb-8">
            Restore Dignity and Well-being
          </h2>
