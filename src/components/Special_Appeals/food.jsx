...
import GazaFood from "../../assets/Gaza_Food.JPG";
import children from "../../assets/children.jpg";
import orphan from "../../assets/orphan.png";
import YemenMalnutrition from "../../assets/Yemen_Malnutrition.png";
import DrinkWater from "../../assets/Drink_water.png";
...
const predefinedAmounts = [
  ...
  { value: 1350, label: "Family Relief Pack" },
];
...
function Food() {
  const infoCards = [
    "Help families in poverty receive monthly food packs with essentials like rice, oil, and flour.",
    "Support our Ramadan campaign to feed fasting individuals with dignity and love.",
    "Hot meals for the homeless ensure no one sleeps hungry in harsh conditions.",
    "Your donation feeds orphaned children and malnourished babies across crisis-hit regions.",
  ];
  const projects = [
    { title: "Family Food Pack", desc: "Sponsor a monthly food pack for a family.", img: bread },
    { title: "Ramadan Food Drive", desc: "Feed fasting families throughout Ramadan.", img: GazaFood },
    { title: "Hot Meals Program", desc: "Distribute hot meals to the homeless.", img: children },
    { title: "Emergency Food Relief", desc: "Provide food aid in conflict zones.", img: YemenMalnutrition },
    { title: "Orphan Feeding Fund", desc: "Ensure regular meals for orphan children.", img: orphan },
    { title: "Zakat Food Assistance", desc: "Provide food support to the poor using your zakat.", img: DrinkWater },
  ];
  ...
  return (
    <section className="relative text-[#1E1E1E] overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-white via-[#6EDFF6]/90 to-white opacity-90" />
      </div>
      ...
      <div className="relative z-10 mt-20">
        ...
        <section className="px-4 py-8 md:py-10 flex justify-center">
          <iframe
            ...
            src="https://www.youtube.com/embed/JcfKPaQsM4A?autoplay=1&mute=1&enablejsapi=1"
            title="GRT Video 1"
            frameBorder="0"
        ...
        <div className="px-6 py-14 bg-gradient-to-b from-white/15 via-[#6EDFF6] to-[#6EDFF6] text-center">
          <h2 className="text-3xl font-bold mb-8">
            Help Feed the Hungry and Transform Lives
          </h2>
